...
BinaryToFloat64(xb::Union{BigInt,Vector{BigInt},Matrix{BigInt}},seq::Union{DigitalSeqB2G,RandomDigitalShift,RandomOwenScramble}) = BinaryToFloat64.(xb,seq.recipd)

BinaryToFloat64(xbs::Vector{Matrix{BigInt}},rds::Union{RandomDigitalShift,RandomOwenScramble}) = [BinaryToFloat64(xb,rds) for xb in xbs]
